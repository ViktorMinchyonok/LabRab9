...
<%@taglib prefix="ad" uri="http://bsu.rfe.java.group9.lab9.Minchyonok.tag/ad" %>
...
<jsp:useBean id="userData" class="bsu.rfe.java.group9.lab9.Minchyonok.entity.User" scope="session" />
